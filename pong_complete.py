...
def collision_detection():
    global velocity_x, velocity_y, ball_x, ball_y, paddle1_x, paddle1_y, paddle2_x, paddle2_y
    # bouncing the ball off the paddle 1
    if ball_x - ball_radius <= paddle1_x + paddle_width and ball_y + ball_radius >= paddle1_y and ball_y - ball_radius <= paddle1_y + paddle_height:
        velocity_x = -velocity_x
        #velocity_y = -velocity_y

    # bouncing the ball off the paddle 2
    if ball_x + ball_radius >= paddle2_x and ball_y + ball_radius >= paddle2_y and ball_y - ball_radius <= paddle2_y + paddle_height:
        velocity_x = -velocity_x
        #velocity_y = -velocity_y
